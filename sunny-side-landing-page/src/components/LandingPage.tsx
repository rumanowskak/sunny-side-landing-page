        ...
        <div className="landing-page">
            ...
            <div className='egg-section'>
                <div className='description-section'>
                    <div className='main-text-description-section'>
                ...
                <div className='egg-image-section'>

                </div>
            </div>
            <div className='glass-section'>
                <div className='glass-image-section'></div>
                <div className='description-section'>
                    <div className='main-text-description-section'>
                        <div className='description-title'>
            ...
            <div className='fruits-section'>
                <div className='cherries-image-section'>
                    <div className='fruit-section-title cherries-text'>
                        Graphic Design
                    </div>
                    <div className='fruit-section-description cherries-text'>
                ...
                <div className='orange-image-section'>
                    <div className='fruit-section-title orange-text'>
                        Photography
                    </div>
                    <div className='fruit-section-description orange-text'>
                        Increase your credability by getting the most stunning, high-quality photos
                        that improve your business image.
                    </div>
                </div>
            </div>
            <div className='clients-testimonials-section'>
                <div className='clients-testimonials-title'>
                    CLIENT TESTIMONIALS
                </div>
                <div className='clients-testimonials-main-part'>
                    <div className='client-section'>
                        <div className='client-photo-1'></div>
                        ...
                        <div className='client-job'>Marketing Director</div>
                    </div>
                    <div className='client-section'>
                        <div className='client-photo-2'></div> 
                        <div className='client-text'>
                            Sunnyside's enthusiasm coupled with their keen in our brand's success made it
                            a satisfying and enjoyable experience.
                        </div>
                        <div className='client-name'> Thomas S. </div>
                        <div className='client-job'> Chief Operating Officer</div>
                    </div>
                    <div className='client-section'>
                        <div className='client-photo-3'></div>
                        <div className='client-text'>
                        ...
                        <div className='client-job'> Business Owner </div>
                    </div>
                </div>
            </div>
